    ...
    while ( (c = fgetc(f)) != EOF ) {
        ...
        switch(etat){
            ...
            case 4:
                ...
                fseek(f, -1, SEEK_CUR);
                symbole.UL = NB;
                strco(symbole.attribute,chaine);
